...
const EmetophobiaTest = lazy(() => import("./pages/EmetophobiaTest.tsx"));
const NomophobiaTest = lazy(() => import("./pages/NomophobiaTest.tsx"));
const ClaustrophobiaTest = lazy(() => import("./pages/ClaustrophobiaTest.tsx"));
const CyberchondriaTest = lazy(() => import("./pages/CyberchondriaTest.tsx"));
const AcrophobiaTest = lazy(() => import("./pages/AcrophobiaTest.tsx"));
const GlossophobiaTest = lazy(() => import("./pages/GlossophobiaTest.tsx"));
            ...
            <BrowserRouter>
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route path="/quiz/maladaptive-daydreaming" element={<MaladaptiveDaydreamingTest />} />
                  <Route path="/quiz/immersive-daydreaming" element={<MaladaptiveDaydreamingTest />} />
                  <Route path="/tes-maladaptive-daydreaming" element={<MaladaptiveDaydreamingTest />} />
                  ...
                  <Route path="/quiz/rocd" element={<RocdTest />} />
                  <Route path="/quiz/relationship-ocd" element={<RocdTest />} />
                  <Route path="/tes-rocd" element={<RocdTest />} />
                  ...
                  <Route path="/quiz/comparison-trap" element={<ComparisonTrapTest />} />
                  <Route path="/quiz/social-media-envy" element={<ComparisonTrapTest />} />
                  <Route path="/tes-comparison-trap" element={<ComparisonTrapTest />} />
                  ...
                  <Route path="/quiz/chronic-resentment" element={<ChronicResentmentTest />} />
                  <Route path="/quiz/grudge-holding" element={<ChronicResentmentTest />} />
                  <Route path="/tes-resentment" element={<ChronicResentmentTest />} />
                  ...
                  <Route path="/quiz/thanatophobia" element={<ThanatophobiaTest />} />
                  <Route path="/quiz/death-anxiety" element={<ThanatophobiaTest />} />
                  <Route path="/tes-thanatophobia" element={<ThanatophobiaTest />} />
                  ...
                  <Route path="/quiz/agoraphobia" element={<AgoraphobiaTest />} />
                  <Route path="/quiz/panic-avoidance" element={<AgoraphobiaTest />} />
                  <Route path="/tes-agorafobia" element={<AgoraphobiaTest />} />
                  ...
                  <Route path="/quiz/somniphobia" element={<SomniphobiaTest />} />
                  <Route path="/quiz/sleep-dread" element={<SomniphobiaTest />} />
                  <Route path="/tes-takut-tidur" element={<SomniphobiaTest />} />
                  <Route path="/tes-somnifobia" element={<SomniphobiaTest />} />
                  <Route path="/quiz/family-scapegoat" element={<FamilyScapegoatTest />} />
                  ...
                  <Route path="/quiz/emetophobia" element={<EmetophobiaTest />} />
                  <Route path="/quiz/fear-of-vomiting" element={<EmetophobiaTest />} />
                  <Route path="/tes-emetofobia" element={<EmetophobiaTest />} />
                  <Route path="/tes-takut-muntah" element={<EmetophobiaTest />} />
                  <Route path="/quiz/nomophobia" element={<NomophobiaTest />} />
                  <Route path="/quiz/smartphone-separation-anxiety" element={<NomophobiaTest />} />
                  <Route path="/tes-nomofobia" element={<NomophobiaTest />} />
                  <Route path="/tes-ketergantungan-hp" element={<NomophobiaTest />} />
                  <Route path="/quiz/claustrophobia" element={<ClaustrophobiaTest />} />
                  <Route path="/quiz/enclosed-space-anxiety" element={<ClaustrophobiaTest />} />
                  <Route path="/tes-klaustrofobia" element={<ClaustrophobiaTest />} />
                  <Route path="/tes-takut-ruang-sempit" element={<ClaustrophobiaTest />} />
                  <Route path="/quiz/cyberchondria" element={<CyberchondriaTest />} />
                  <Route path="/quiz/health-anxiety-online" element={<CyberchondriaTest />} />
                  <Route path="/tes-cyberchondria" element={<CyberchondriaTest />} />
                  <Route path="/tes-cemas-penyakit-online" element={<CyberchondriaTest />} />
                  <Route path="/quiz/acrophobia" element={<AcrophobiaTest />} />
                  <Route path="/quiz/fear-of-heights" element={<AcrophobiaTest />} />
                  <Route path="/tes-akrofobia" element={<AcrophobiaTest />} />
                  <Route path="/tes-takut-ketinggian" element={<AcrophobiaTest />} />
                  <Route path="/quiz/glossophobia" element={<GlossophobiaTest />} />
                  <Route path="/quiz/public-speaking-anxiety" element={<GlossophobiaTest />} />
                  <Route path="/tes-glosofobia" element={<GlossophobiaTest />} />
                  <Route path="/tes-takut-bicara-di-depan-umum" element={<GlossophobiaTest />} />
