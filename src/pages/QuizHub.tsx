    ...
    <div className="min-h-screen bg-[#FAF9F6] text-neutral-900 selection:bg-amber-200">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          ...
          {/* Card 86: Chronic Resentment & Grudge Holding Screener */}
          <div className="rounded-3xl border border-rose-300 bg-gradient-to-br from-rose-500/10 via-rose-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                  <Scale className="h-3 w-3" />
                  STANFORD FORGIVENESS MODEL
                </span>
                <span className="text-xs font-semibold text-rose-800">Dr. F. Luskin &amp; Dr. R. Enright</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Chronic Resentment &amp; Grudge Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Do past betrayals replay as imaginary arguments years later? Screen grievance rumination, somatic bitterness, and defensive hostility.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-rose-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                to="/quiz/chronic-resentment"
                className="inline-flex items-center gap-1.5 rounded-full bg-rose-600 px-4 py-2 text-xs font-bold text-white hover:bg-rose-700 transition shadow-xs"
              >
                <span>Screen Resentment Load</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 87: Pathological Altruism & Savior Complex Screener */}
          <div className="rounded-3xl border border-purple-300 bg-gradient-to-br from-purple-500/10 via-purple-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-purple-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                  <HeartHandshake className="h-3 w-3" />
                  PATHOLOGICAL ALTRUISM MODEL
                </span>
                <span className="text-xs font-semibold text-purple-800">Dr. Barbara Oakley Architecture</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Pathological Altruism &amp; Savior Complex Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Does saying "no" induce unbearable bodily guilt? Screen destructive rescuing, enabler boundary erosion, and martyrdom depletion.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-purple-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                to="/quiz/pathological-altruism"
                className="inline-flex items-center gap-1.5 rounded-full bg-purple-600 px-4 py-2 text-xs font-bold text-white hover:bg-purple-700 transition shadow-xs"
              >
                <span>Screen Savior Complex</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>
          ...
          {/* Card 90: Thanatophobia & Existential Death Anxiety Screener */}
          <div className="rounded-3xl border border-amber-300 bg-gradient-to-br from-amber-500/10 via-amber-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-500 px-3 py-0.5 text-xs font-bold text-neutral-950 shadow-xs">
                  <Compass className="h-3 w-3" />
                  YALOM &amp; TMT MODEL
                </span>
                <span className="text-xs font-semibold text-amber-800">Dr. Irvin D. Yalom</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Thanatophobia &amp; Death Anxiety Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Do thoughts of mortality trigger heart palpitations, nocturnal dread, or panic before falling asleep? Screen existential annihilation dread and mortality salience.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-amber-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-amber-500 px-4 py-2 text-xs font-bold text-neutral-950 hover:bg-amber-600 transition shadow-xs"
              >
                <span>Screen Thanatophobia</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 91: Executive Dysfunction & Task Paralysis Screener */}
          <div className="rounded-3xl border border-sky-300 bg-gradient-to-br from-sky-500/10 via-indigo-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-sky-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-sky-800">Dr. Russell Barkley</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Executive Dysfunction &amp; Task Paralysis Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Staring at your screen screaming internally to start while frozen in place? Differentiate laziness from neurological task initiation friction and time blindness.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-sky-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                to="/quiz/executive-dysfunction"
                className="inline-flex items-center gap-1.5 rounded-full bg-sky-600 px-4 py-2 text-xs font-bold text-white hover:bg-sky-700 transition shadow-xs"
              >
                <span>Screen Task Paralysis</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 92: Body Dysmorphia & Mirror Checking Screener */}
          <div className="rounded-3xl border border-rose-300 bg-gradient-to-br from-rose-500/10 via-rose-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-rose-800">Dr. Katharine Phillips</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Body Dysmorphia &amp; Mirror Checking Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Do perceived flaws, compulsive mirror rituals, or dread of photos consume hours of your day? Screen perceptual zooming and body dysmorphic friction.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-rose-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-rose-600 px-4 py-2 text-xs font-bold text-white hover:bg-rose-700 transition shadow-xs"
              >
                <span>Screen Body Dysmorphia</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 93: Health Anxiety & Cyberchondria Screener */}
          <div className="rounded-3xl border border-emerald-300 bg-gradient-to-br from-emerald-500/10 via-teal-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-emerald-800">Dr. Paul Salkovskis</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Health Anxiety &amp; Cyberchondria Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Does an unfamiliar twitch or chest flutter trigger catastrophic illness fears and symptom googling spirals? Screen cyberchondria and interoceptive alarm.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-emerald-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-emerald-600 px-4 py-2 text-xs font-bold text-white hover:bg-emerald-700 transition shadow-xs"
              >
                <span>Screen Health Anxiety</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>
          ...
          {/* Card 96: Anhedonia & Reward Deficiency Screener */}
          <div className="rounded-3xl border border-purple-300 bg-gradient-to-br from-purple-500/10 via-purple-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-purple-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-purple-800">Dr. R. Philip Snaith</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Anhedonia &amp; Reward Deficiency Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Has food, music, hobbies, and social connection turned completely grey and joyless? Screen sensory savoring deficits and dopamine flatlining.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-purple-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-purple-600 px-4 py-2 text-xs font-bold text-white hover:bg-purple-700 transition shadow-xs"
              >
                <span>Screen Anhedonia</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 97: Misophonia & Selective Sound Rage Screener */}
          <div className="rounded-3xl border border-rose-300 bg-gradient-to-br from-rose-500/10 via-rose-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-rose-800">Dr. Damiaan Denys</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Misophonia &amp; Selective Sound Rage Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Do chewing, crunching, breathing, or tapping sounds trigger instantaneous visceral fury and flight-or-fight panic? Screen sound rage triggers.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-rose-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-rose-600 px-4 py-2 text-xs font-bold text-white hover:bg-rose-700 transition shadow-xs"
              >
                <span>Screen Misophonia</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 98: Agoraphobia & Panic Escape Dread Screener */}
          <div className="rounded-3xl border border-amber-300 bg-gradient-to-br from-amber-500/10 via-amber-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-amber-800">Dr. Borwin Bandelow</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Agoraphobia &amp; Panic Escape Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Terrified of crowded stores, traffic gridlocks, transit, or leaving home without a safe person? Screen panic entrapment and comfort zone shrinkage.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-amber-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-amber-600 px-4 py-2 text-xs font-bold text-white hover:bg-amber-700 transition shadow-xs"
              >
                <span>Screen Agoraphobia</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 99: Covert Narcissism & Vulnerable Self-Absorption Screener */}
          <div className="rounded-3xl border border-indigo-300 bg-gradient-to-br from-indigo-500/10 via-indigo-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-indigo-800">Dr. Jonathan Cheek</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Covert Narcissism &amp; Vulnerability Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Quiet on the outside but hyper-defensive, harboring secret superiority, and nursing bitter resentment when others succeed? Screen covert entitlement.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-indigo-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                to="/quiz/covert-narcissism"
                className="inline-flex items-center gap-1.5 rounded-full bg-indigo-600 px-4 py-2 text-xs font-bold text-white hover:bg-indigo-700 transition shadow-xs"
              >
                <span>Screen Covert Narcissism</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>
          ...
          {/* Card 112: Claustrophobia & Enclosed Space Anxiety Screener */}
          <div className="rounded-3xl border border-sky-300 bg-gradient-to-br from-sky-500/10 via-slate-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-sky-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                  <Wind className="h-3 w-3" />
                ...
                <span className="text-xs font-semibold text-sky-800">Prof. Jack Rachman</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Claustrophobia (Enclosed Space Anxiety) Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Do you panic when elevator doors close, dread windowless rooms or MRI machines, and constantly plan escape routes? Screen suffocation and restriction fears.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-sky-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                to="/quiz/claustrophobia"
                className="inline-flex items-center gap-1.5 rounded-full bg-sky-600 px-4 py-2 text-xs font-bold text-white hover:bg-sky-700 transition shadow-xs"
              >
                <span>Screen Claustrophobia</span>
                <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>

          {/* Card 113: Cyberchondria & Online Health Anxiety Screener */}
          <div className="rounded-3xl border border-emerald-300 bg-gradient-to-br from-emerald-500/10 via-teal-50 to-white p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-600 px-3 py-0.5 text-xs font-bold text-white shadow-xs">
                ...
                <span className="text-xs font-semibold text-emerald-800">Dr. Vladan Starcevic</span>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1.5">
                Cyberchondria (Online Health Anxiety) Screener
              </h3>
              <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                Do you spend late nights googling minor physical symptoms, obsess over smartwatch heart rate spikes, and distrust clear doctor reports? Measure clinical cyberchondria.
              </p>
            </div>
            <div className="mt-5 pt-3 border-t border-emerald-100 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">~90 Secs · 12 Items</span>
              <Link
                to="/quiz/cyberchondria"
                className="inline-flex items-center gap-1.5 rounded-full bg-emerald-600 px-4 py-2 text-xs font-bold text-white hover:bg-emerald-700 transition shadow-xs"
              >
