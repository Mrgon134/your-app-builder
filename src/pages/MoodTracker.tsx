      ...
      <footer className="border-t border-border/60 px-4 py-8">
        <div className="mx-auto max-w-3xl space-y-4 text-sm text-muted-foreground">
          ...
          <div className="border-t border-border/40 pt-4 text-xs flex flex-wrap gap-x-4 gap-y-2">
            ...
            <Link to="/blog/daylio-alternatives" className="hover:text-foreground transition-colors">Daylio Alternatives</Link>
            <Link to="/blog/best-mood-tracker-apps" className="hover:text-foreground transition-colors">Best Mood Tracker Apps</Link>
