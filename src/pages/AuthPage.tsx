...
const AuthPage: React.FC = () => {
  ...
  const nativeIOS = isNative() && isIOS();
  const appleSignInEnabled = import.meta.env.VITE_ENABLE_APPLE_SIGN_IN === "true";
  const showGoogleLogin = !nativeIOS;
  const showAppleLogin = appleSignInEnabled;
  ...
  return (
    <>
      ...
      <div className="w-full max-w-[340px]">
        ...
        {!isCheckoutClaimFlow && showSocialLogin ? (
        ...
        <div className={`flex items-center gap-3 mb-4 ${showSocialLogin || isCheckoutClaimFlow ? "" : "mt-2"}`}>
