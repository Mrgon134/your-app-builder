...
> = {
  ...
  nl: {
    ...
    tryFree: "Probeer Nuju gratis",
    minRead: "min leestijd",
    onThisPage: "Op deze pagina",
    faqTitle: "Veelgestelde vragen",
    relatedTitle: "Lees ook",
    ctaEyebrow: "Ervaar het zelf",
    ctaTitle: "Begin vandaag je eerste dagboekbericht",
    ctaBody: "Nuju kost 30 seconden per dag. Spreek of typ, ontvang AI-inzichten en begrijp je emotionele patronen zonder gedoe.",
    ctaButton: "Gratis beginnen met journalen",
  ...
  zh: {
    ...
    relatedTitle: "推荐阅读",
    ctaEyebrow: "亲身体验",
    ctaTitle: "今天开启你的第一篇心情日记",
    ctaBody: "Nuju 每天仅需 30 秒。语音或文字倾诉，获得 AI 深度共情解读，轻松厘清你的情绪脉络。",
    ctaButton: "免费开始写日记",
    backToBlog: "返回文章列表",
    footerAbout: "关于我们",
    footerSupport: "帮助支持",
