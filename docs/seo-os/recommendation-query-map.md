...
| --- | --- | --- | --- |
| `best ai journaling app` | Live | `/blog/best-ai-journaling-apps` | Reveal |
| `best mood tracker app` | Live | `/blog/best-mood-tracker-apps` | Reveal |
| `best journaling app` | Live | `/blog/best-journaling-apps-2026` | Reveal |
...
Live recommendation-intent pages after this update:

1. `/blog/best-ai-journaling-apps`
...
Prioritize pages where all three conditions are true:

- the SERP clearly shows recommendation, comparison, or switch intent
- Nuju has a believable angle to win on
- the page can send readers cleanly to reveal or install
