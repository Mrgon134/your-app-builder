...
const getProductPlanMap = () => ({
  ...
  [Deno.env.get("VITE_DODO_EBOOK_BASIC") || Deno.env.get("DODO_EBOOK_BASIC_PRODUCT_ID") || "pdt_ebook_basic"]: "ebook_basic",
  [Deno.env.get("VITE_DODO_EBOOK_BUNDLE") || Deno.env.get("DODO_EBOOK_BUNDLE_PRODUCT_ID") || "pdt_ebook_bundle"]: "ebook_bundle",
});
